...
const MobilePhone = ({ image }) => {
  return (
    <div className="w-1/2 h-96 bg-gray-50  flex flex-col items-center justify-center px-4 border-black">
      <div className="w-full pt-3 pb-1 bg-black rounded-t-2xl flex justify-center items-center">
